"""HTTP wrapper for the AgentCore Memory lab.

The UI passes a stable session_id per browser session so turn 2 can recall
turn 1's context from AgentCore Memory.
"""
